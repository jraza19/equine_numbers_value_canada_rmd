...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1. Number of Horses Per Province", out.width= '100%'}
...
kable(max_horses, 
        caption = "Table 1: Maximum and minimum number of horses in Canadian Provinces between 1940 - 1972")
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Figure 2. The horse population for province of focus", out.width = "50%"}
